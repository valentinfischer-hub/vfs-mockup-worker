...
REGEL V40-K · STRUKTUR (KRITISCH): <header>-Tag enthält AUSSCHLIESSLICH die Top-Navigation (Logo + Nav-Items + Calendly-CTA-Button). Header MUSS max-height:80px haben und position:sticky;top:0. Hero ist eine EIGENE <section class="hero">, NIEMALS im <header>-Tag. Verstoesse fuehren zu kaputter Scroll-UX (Hero verdeckt alles darunter).

REGEL V40-L · MAX 7 SECTIONS (zwingend, branche-spezifisch). Welche 7 ist abhaengig vom Cluster:

- Cluster A Editorial (Architektur/Hotel/Atelier/Galerie/Showroom): Hero / Manifest-Story / Portfolio-Werke / Process-Material / Team / Standort-Kontakt / Footer
- Cluster B Hospitality (Restaurant/Cafe/Bar/Hotel): Hero / Story / Karte-Menue / Reservation-3Step / Galerie / Standort-Oeffnungszeiten / Footer
- Cluster C Premium-Brand (Schmuck/Uhren/Moebel-Hersteller): Hero / Manifest / Kollektion / Material-Craft / Showroom-Standort / Kontakt / Footer
- Cluster D Beratung (Coaching/Anwalt/Consultant): Hero / Ueber-uns / Leistungen / Termin / Reviews / Kontakt-Standort / Footer
- Cluster E Medizin (Wellness/Spa/Physio): Hero / Therapie-Ansatz / Behandlungen / Termin / Team / Standort-Oeffnungszeiten / Footer
- Cluster F Lokales-KMU (Coiffeur/Maler/Schreiner): Hero / Trust-Story / Leistungen / Termin / Galerie / Standort-Oeffnungszeiten / Footer
- Cluster G Tech (SaaS/Agency/Digital): Hero / Manifest / Services / Cases / Team / Kontakt / Footer

Diese 7 sind PFLICHT-Reihenfolge. KEINE zusaetzlichen Sections (kein Trust-Strip extra, keine Quote-Bridge extra, keine Stat-Band extra). Quote-Bridges/Marquee-Ribbons/Stat-Bands als VISUELLE BRIDGES zwischen den 7 Sections sind OK aber NICHT als eigene <section>-Tags.

REGEL V40-M · SCROLL-MUSS-FUNKTIONIEREN: Pre-Output Check: window.scrollTo(0, 1000) muss funktionieren. KEIN body{overflow:hidden}. KEIN html{overflow:hidden}. KEIN scroll-snap-type ohne entsprechenden snap-align. NIEMALS scroll-Listener mit preventDefault() schreiben. Lenis-Init darf scroll nicht blockieren.
${auditBlock}
</v40_vfs_overlay>
...
V37.3 OVERRIDE PFLICHT (ueberschreibt V37.2 bei Konflikt) - active 2026-05-07

UMLAUT-HARTE-REGEL: Echte ä, ö, ü und ss IMMER. NIE ae/oe/ue im Body. Nur in URLs/href/Slugs erlaubt. Vor-Output: zaehle ä/ö/ü, zaehle ae/oe/ue ausserhalb URLs. Wenn ae/oe/ue > 0 ausserhalb URLs: regeneriere bis 0.

VORSCHAU-BANNER PFLICHT als allererste Section vor Nav: <div style="position:sticky;top:0;z-index:9999;background:#000;color:#fff;text-align:center;padding:8px;font-size:13px;height:32px;line-height:16px">VORSCHAU · Design-Entwurf von vf-services für ${profile.company || profile.firma || "Ihr Business"} · Finale Inhalte, Bilder und Konfiguration im Go-Live</div>

KONZEPT-BADGE PFLICHT in jeder Hero-Section: <div style="display:inline-block;background:#EA6A2A;color:#fff;padding:4px 12px;border-radius:4px;font-size:11px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;margin-bottom:16px">KONZEPT</div>

VF-SERVICES COLOR-TOKENS: Hauptfarbe #FAFAF7 (warm-beige bg), Akzent #EA6A2A (orange CTA), Text #0A0A0A (dunkel), Sekundaer #2D2D2D. Footer-Block in genau diesen Farben mit Termin-CTA.

7 PFLICHT-SEKTIONEN (Reihenfolge fix):
1. Hero mit KONZEPT-Badge + Headline + Subline + Primary-CTA
2. Trust-Bar (Branche-Pain-Story 3 Stats oder Mini-Testimonial-Strip)
3. Service-Grid 3-Cards mit Icon + Title + 1-Sentence-Pitch
4. Process-Timeline 4-Schritt (Anfrage → Termin → Konzept → Go-Live)
5. Authentic CH-Testimonials 1-2 mit echtem Namen + Branche
6. Inline-Calendly-Widget oder Termin-Button mit deutscher Microcopy
7. Footer-Block in vf-services-Farben mit klar sichtbarem Termin-CTA + "Was noch ergänzt werden könnte" Notiz

10 CONVERSION-PATTERNS:
- Live-Slot-Preview: zeige naechste 3 freie Slots aus Calendly-RPC inline
- Branche-Pain-Story: spezifische Statistik aus Branche-Pool oben
- Mobile Sticky Bottom-Bar: fixed Termin-Button auf mobile <768px
- KONZEPT-Badge: orange-Pille in Hero-Section
- Inline-Calendly-Widget: iframe mit calendly.com/valentin-fischer-vf-services/30min
- Lead-Capture-Form: Footer-Form mit Name+Email+Anliegen, submit zu lead-capture-form Edge-Function
- Schweizer-Stadt-Microcopy: ortsspezifische Hooks (z.B. "Termin in Zürich" wenn ZH-PLZ)
- Curiosity-3-Cards: 3 Pain-Karten mit "Kennen Sie das auch?"-Frame
- Echte CH-Testimonials: 1-2 mit echtem Schweizer Namen + Branche aus testimonials_pool
- Process-Timeline: 4-Schritt-Visualisierung mit Datum-Range

STATUS V37.3 active 2026-05-07.`;
}
// =====================================================================

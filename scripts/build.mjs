...
function buildV37SystemPrompt(profile, mockupId, supabaseUrl, prospectAudit) {\n  const V37_3_OVERRIDE = `\n\nV37.3 OVERRIDE PFLICHT (ueberschreibt V37.2 bei Konflikt) - active 2026-05-07\n\nUMLAUT-HARTE-REGEL: Echte ä, ö, ü und ss IMMER. NIE ae/oe/ue im Body. Nur in URLs/href/Slugs erlaubt. Vor-Output: zaehle ä/ö/ü, zaehle ae/oe/ue ausserhalb URLs. Wenn ae/oe/ue > 0 ausserhalb URLs: regeneriere bis 0.\n\nVORSCHAU-BANNER PFLICHT als allererste Section vor Nav: <div style="position:sticky;top:0;z-index:9999;background:#000;color:#fff;text-align:center;padding:8px;font-size:13px;height:32px;line-height:16px">VORSCHAU · Design-Entwurf von vf-services fuer ${profile.company || profile.firma || \"Ihr Business\"} · Finale Inhalte, Bilder & Konfiguration im Go-Live</div>\n\nKONZEPT-Badge Header rechts oben: KONZEPT-VORSCHAU · Echte Version in 36h nach Termin\n\nFOOTER-CTA-FARBEN PFLICHT (vf-services.ch-Tokens): --vfs-bg #FAFAF7, --vfs-text #0A0A0A, --vfs-accent #EA6A2A, --vfs-accent-text #FFFFFF. Pill-Button Termin buchen: border-radius 9999px, padding 14px 28px, background #EA6A2A, color white, font-weight 600.\n\nMOBILE STICKY BOTTOM-BAR PFLICHT bei <768px: fixe 64px-Bar unten, links Anrufen rechts Termin buchen Calendly. Background #EA6A2A, color white. z-index 9999.\n\nLIVE-SLOT-PREVIEW PFLICHT im Hero + Footer: 3 Pill-Buttons mit synthetischen Slots (Mi/Do/Fr Naechstwerktag).\n\nLEAD-CAPTURE-MINI-FORM PFLICHT im Footer-CTA unter Calendly: Title \"Keine Zeit fuer Termin? Senden Sie uns 1 Frage.\" + Email-Field pre-filled + Textarea + Submit. POST zu https://kvtmkabkmouzljhsxgir.supabase.co/functions/v1/lead-capture-form mit JSON {email, question, source_mockup_url, source_company, source_branche}.\n\nCURIOSITY-3-CARDS \"Im Termin ergaenzen wir gemeinsam\" PFLICHT VOR Calendly-Embed: 1) Top-3 Leistungen mit echten Preisen, 2) Foto-Material aus Praxisalltag, 3) Individuelle Werte.\n\nPROCESS-TIMELINE 4-STEPS PFLICHT zwischen Reviews und Footer-CTA: 1) 30-Min-Termin via Calendly, 2) 36h Mockup-V2 mit Inhalten, 3) 7 Tage Live-Schaltung, 4) Laufende Optimierung.\n\nSCHWEIZER-STADT-MICROCOPY PFLICHT: Lead-Stadt in mind. 4 Stellen erwaehnen.\n\nBRANCHE-PAIN-STORY PFLICHT im Hero-Subtitle. physio: Damit Erstanfragen nicht mehr zwischen Telefonen verloren gehen. coiffeur: Damit Walk-Ins nicht an Konkurrenz mit Online-Buchung gehen. schreiner: Damit Auftraege nicht an unsichtbarere Mitbewerber verloren gehen. treuhand: Damit Sie nicht 5x am Tag Tarif-Fragen am Telefon beantworten muessen. restaurant: Damit Reservationen nicht nur per Telefon kommen. anwalt: Damit Erstmandate nicht an Kanzleien mit besserer Online-Praesenz gehen. architekt: Damit Bauherren Projekte schon mobil ueberzeugend sehen.\n\nVERBOTEN: Werte/Geschichte/Vision/Newsletter/Blog/FAQ/Pricing/Em-Dashes (—). 9-Sektionen reduziert auf 7.\n\nSTATUS V37.3 active 2026-05-07.\n`;
  const p = profile;
  const pal = p.palette;
